  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Download FitPlanCoach for Android" },
      {
        ...
        content: "Personalized workouts, meal plans, and progress tracking — free on Google Play.",
      },
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Home", item: "https://fitplancoach.com/" },
            {
              ...
              position: 2,
              name: "Download",
              item: "https://fitplancoach.com/download",
            },
          ],
        }),
      },
...
const WHY_INSTALL = [
  {
    icon: WifiOff,
    title: "Your plan, on your phone",
    body: "Your current meal plan is saved to your device, so you can check today's food even if you lose your connection.",
  },
  {
    icon: Bell,
    title: "Gentle reminders",
    body: "Optional nudges help you keep your streak and never miss a planned session. Turn them off any time.",
  },
  {
    icon: Gauge,
    title: "Faster and smoother",
    body: "A native-feeling home-screen app: instant launch, fluid navigation, and one-tap logging.",
  },
  {
    icon: Flame,
    title: "Streaks that motivate",
    body: "Watch your consistency build day by day. Progress you can see is progress you keep.",
  },
  {
    icon: ShieldCheck,
    title: "Private by default",
    body: "Encrypted in transit and protected by row-level security. Your data is yours — never sold.",
  },
  {
    icon: Smartphone,
    title: "Always with you",
    body: "Log meals and weight the moment they happen, straight from your phone's home screen.",
  },
];
...
const OUTCOMES = [
  {
    icon: TrendingDown,
    title: "Lose fat without guesswork",
    body: "Calorie and macro targets calculated for your body, with meals you'll actually eat.",
  },
  {
    icon: Dumbbell,
    title: "Build strength with structure",
    body: "Progressive workouts matched to your equipment and experience — beginner to advanced.",
  },
  {
    icon: Target,
    title: "Stay consistent",
    body: "Simple daily actions, visible streaks, and weekly check-ins keep you on track.",
  },
];
...
const APP_FAQ = [
  {
    q: "Is the app free?",
    a: "Yes. Download and start free — generate a plan and track your basics at no cost. Premium plans unlock weekly regeneration and deeper customization, and you can upgrade whenever you're ready.",
  },
  {
    q: "Which Android versions are supported?",
    a: `FitPlanCoach runs on Android ${ANDROID_MIN_VERSION} and newer, which covers the vast majority of active devices.`,
  },
  {
    q: "Is there an iPhone version?",
    a: "Not yet — Android is first. In the meantime, FitPlanCoach works in any modern browser, and you can add it to your iPhone home screen from Safari for an app-like experience.",
  },
  {
    q: "Does it work offline?",
    a: "Your current meal plan is saved on your device, so you can still view it if you lose your connection. Generating new plans and logging your progress require you to be online.",
  },
  {
    q: "Will my data be safe?",
    a: "Your data is encrypted in transit, protected by row-level security so only you can see it, and never sold. You can export or delete it any time.",
  },
];
      ...
      <main id="main-content" tabIndex={-1} className="flex-1">
          ...
          <div className="relative mx-auto max-w-6xl px-6 pt-16 pb-20 grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex items-center justify-center lg:justify-start gap-3 flex-wrap">
                ...
                <Link to="/auth">
                  <Button
                    size="lg"
                    variant="outline"
                    className="font-bold uppercase tracking-wider px-6 h-14 border-border-strong"
                  >
                    Use it on the web
                  </Button>
                </Link>
              ...
              <div className="mt-8 flex items-center justify-center lg:justify-start gap-5 text-[11px] font-bold uppercase tracking-widest text-muted-foreground flex-wrap">
                ...
                <span className="flex items-center gap-1.5">
                  <Check className="size-3 text-primary" /> Private &amp; secure
                </span>
              </div>
            </div>
        ...
        <section className="border-t border-border">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <h2 className="mt-3 text-3xl md:text-4xl font-display uppercase italic">
              ...
              {[
                {
                  ...
                  sub: "Calories, macros & streak at a glance",
                },
                {
                  screen: <WorkoutScreen />,
                  label: "Guided workouts",
                  sub: "Today's session, set by set",
                },
        ...
        <section className="border-t border-border">
          <div className="mx-auto max-w-3xl px-6 py-20 text-center">
            <h2 className="text-3xl md:text-5xl font-display uppercase italic tracking-tight">
              Start today
            </h2>
