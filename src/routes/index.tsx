  ...
  head: () => ({
    meta: [
      { title: "FitPlanCoach — Personalized Workout & Meal Plans for Android" },
      {
        name: "description",
        content:
          "FitPlanCoach builds personalized workouts and meal plans around your body, goals, schedule, and budget — then tracks your progress. Free on Android. No credit card, cancel anytime.",
      },
      { property: "og:title", content: "FitPlanCoach — Personalized Workout & Meal Plans" },
      {
        property: "og:description",
        content:
          "Personalized fitness and nutrition that adapts to you. Free on Android. Start in minutes.",
      },
...
const HOW_IT_WORKS = [
  {
    ...
    body: "A 5-minute onboarding covers your body metrics, activity level, goals, food preferences, equipment, and how many days you can train.",
  },
  {
    n: "02",
    icon: Zap,
    title: "Get your plan",
    body: "We calculate your calorie and macro targets with proven sports-nutrition formulas, then build meals and workouts that match — instantly.",
  },
  {
    n: "03",
    icon: LineChart,
    title: "Track and adapt",
    body: "Log meals, weight, and sessions in a tap. See your trends each week. Pro members get a fresh plan every week to keep momentum.",
  },
];
...
const FEATURES = [
  {
    ...
    body: "Daily meals matched to your macros and budget, respecting allergies and foods you dislike. Swap any meal for an equivalent in one tap.",
  },
  {
    icon: Dumbbell,
    title: "Workouts that fit real life",
    body: "Gym, home, or hybrid. Three days or six. Beginner to advanced. Progressive overload is built in so you keep moving forward.",
  },
  {
    icon: ShoppingCart,
    title: "An automatic shopping list",
    body: "Your week of meals becomes one aggregated grocery list — ready for the store or your delivery app. No more guesswork on Sundays.",
  },
  {
    icon: LineChart,
    title: "Progress you can trust",
    body: "Weight trend, workout streak, and calorie & protein adherence in one clear dashboard. Real signals, not vanity metrics.",
  },
  {
    icon: Calendar,
    title: "Weekly regeneration",
    body: "Pro members get a fresh meal and workout plan every week — preventing food fatigue and training plateaus before they start.",
  },
  {
    icon: ShieldCheck,
    title: "Private by default",
    body: "Your data is encrypted in transit, protected by row-level security, and never sold. It's yours to export or delete any time.",
  },
];
...
const TESTIMONIALS = [
  {
    name: "Marcus T.",
    role: "Lost 8 kg in 4 months",
    body: "The plan finally fit my schedule — three workouts a week and meals I actually wanted to eat. I stopped white-knuckling diets and just followed the structure.",
  },
  {
    name: "Priya K.",
    role: "First-time lifter",
    body: "I had no idea what to do at the gym. The progression made sense from day one and I never felt lost. The weekly refresh kept things interesting.",
  },
  {
    name: "Jordan R.",
    role: "Busy parent of two",
    body: "The shopping list saved my Sundays. I batch-cook, then follow the workouts on lunch breaks. Six months consistent — I've never managed that before.",
  },
];
...
const FAQ_TEASER = [
  ...
  },
  {
    ...
    a: "No honest service can. Results depend on consistency, sleep, stress, genetics, and adherence. FitPlanCoach gives you a structured plan and clear tracking — the work is still yours, but you'll never be guessing.",
  },
  {
    q: "Is this medical advice?",
    a: "No. FitPlanCoach provides fitness and nutrition guidance and is not medical advice. Consult a qualified professional before significant changes to your diet or exercise routine.",
  },
  {
    q: "Can I cancel anytime?",
    a: "Yes — cancel anytime from your subscriptions in Google Play. You keep Pro until the end of the current paid period, and refunds follow Google Play's refund policy.",
  },
];
      ...
      <main id="main-content" tabIndex={-1} className="flex-1">
          ...
          <div className="relative mx-auto max-w-6xl px-6 pt-16 pb-20 grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-8 items-center">
            <div className="text-center lg:text-left">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-primary mb-6">
                <Zap className="size-3" fill="currentColor" /> Personalized for your body &amp;
                schedule
              </span>
              ...
              <p className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0">
                FitPlanCoach builds personalized workouts and meal plans around your goals,
                schedule, and budget — then tracks every rep and every kg. No fads. No guesswork.
                Just a plan you'll actually stick to.
              </p>
              ...
              <div className="mt-7 flex items-center justify-center lg:justify-start gap-x-6 gap-y-2 text-[11px] font-bold uppercase tracking-widest text-muted-foreground flex-wrap">
                <span className="flex items-center gap-1.5">
                  <Check className="size-3 text-primary" /> No credit card
                </span>
                <span className="flex items-center gap-1.5">
                  <Check className="size-3 text-primary" /> Cancel anytime
                </span>
                <span className="flex items-center gap-1.5">
                  <RefreshCcw className="size-3 text-primary" /> Free to start
                </span>
                <span className="flex items-center gap-1.5">
                  <Lock className="size-3 text-primary" /> Billed via Google Play
                </span>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-8 grid grid-cols-2 md:grid-cols-4 gap-6 reveal">
            {STATS.map((s) => (
              <div key={s.label} className="text-center md:text-left">
                <div className="text-3xl md:text-4xl font-display italic text-primary tabular-nums">
                  {s.value}
                </div>
        ...
        <section className="mx-auto max-w-6xl px-6 py-20">
          <div className="max-w-2xl reveal">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-display uppercase italic text-balance">
              Getting fit isn't the hard part. Staying consistent is.
            </h2>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 reveal">
            <div className="surface-card p-7">
              <div className="text-xs font-bold uppercase tracking-widest text-destructive/90">
                The usual way
              </div>
        ...
        <section className="border-t border-border bg-card/30">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="max-w-2xl reveal">
              ...
              <h2 className="mt-3 text-3xl md:text-4xl font-display uppercase italic text-balance">
                From signup to your first workout in under 10 minutes
              </h2>
            </div>
            <div className="mt-10 grid gap-5 md:grid-cols-3 reveal">
              {HOW_IT_WORKS.map((s) => (
                <div key={s.n} className="surface-card card-lift p-7 relative">
                  <div className="text-5xl font-display italic text-primary/25 leading-none">
                    {s.n}
                  </div>
        ...
        <section className="mx-auto max-w-6xl px-6 py-20">
          <div className="max-w-2xl reveal">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-display uppercase italic text-balance">
              One app for your training, nutrition, and progress
            </h2>
            <p className="mt-3 text-muted-foreground">
              No more juggling five apps and a spreadsheet. It's all here, and it all talks to
              itself.
            </p>
          </div>
        ...
        <section className="border-t border-border bg-card/30 overflow-hidden">
          <div className="mx-auto max-w-6xl px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative flex justify-center order-2 lg:order-1 reveal">
              <PhoneMockup width={224} className="hidden sm:block translate-y-4 -rotate-3">
                <WorkoutScreen />
              </PhoneMockup>
              <PhoneMockup width={224} className="sm:-ml-16 z-10 sm:rotate-3" glow>
                <DashboardScreen />
              </PhoneMockup>
            </div>
            <div className="order-1 lg:order-2 reveal">
              ...
              <h2 className="mt-3 text-3xl md:text-4xl font-display uppercase italic text-balance">
                Your coach, one tap from the home screen
              </h2>
              <p className="mt-3 text-muted-foreground">
                The Android app keeps your plan, workouts, and tracking always within reach — and
                your current meal plan is saved to your device, so it's there in a tap even on a
              ...
              <ul className="mt-6 space-y-3">
                {[
                  {
                    icon: WifiOff,
                    text: "Your current plan is saved to your device for quick access",
                  },
        ...
        <section className="mx-auto max-w-6xl px-6 py-20">
          <div className="max-w-2xl reveal">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-display uppercase italic text-balance">
              Real people, structured progress
            </h2>
            <p className="mt-3 text-sm text-muted-foreground">
              Individual results vary and depend on consistency, sleep, stress, genetics, and
              adherence.
            </p>
          </div>
          <div className="mt-10 grid gap-5 md:grid-cols-3 reveal">
            {TESTIMONIALS.map((t) => (
              <figure key={t.name} className="surface-card card-lift p-7">
                ...
                <figcaption className="mt-5 flex items-center gap-3">
                  <div className="size-9 rounded-full bg-primary/15 border border-primary/30 inline-flex items-center justify-center font-display italic text-sm">
                    {t.name[0]}
                  </div>
                  <div>
        ...
        <section className="border-t border-border bg-card/30">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="text-center max-w-2xl mx-auto reveal">
              ...
              <p className="mt-3 text-muted-foreground">
                Free to start — no card needed. Upgrade to Pro in the app, billed securely through
                Google Play, and cancel anytime.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  price: "$0",
                  per: "forever",
                  note: "1 personalized plan and basic tracking — yours to keep.",
                },
                {
                  name: "Pro Monthly",
                  price: "$5",
                ...
                <div
                  key={p.name}
                  className={`surface-card card-lift p-6 ${p.featured ? "ring-2 ring-primary/50 shadow-[var(--shadow-lime)]" : ""}`}
                >
                  {p.featured && (
            ...
            <div className="mt-8 text-center">
              <Link to="/pricing">
                <Button
                  variant="outline"
                  className="font-bold uppercase tracking-wider border-border-strong"
                >
          ...
          <div className="mx-auto max-w-6xl px-6 py-10 grid gap-6 md:grid-cols-4 text-center md:text-left reveal">
            {[
              { icon: RefreshCcw, title: "Free to start", body: "No card needed to begin" },
              {
                icon: ShieldCheck,
                title: "Private by default",
                body: "Encrypted, row-level secured",
              },
        ...
        <section className="relative overflow-hidden border-t border-border bg-card/30">
          ...
          <div className="relative mx-auto max-w-3xl px-6 py-20 text-center reveal">
            <h2 className="text-3xl md:text-5xl font-display uppercase italic tracking-tight text-balance">
              Ready to move?
            </h2>
            <p className="mt-4 text-muted-foreground">
              Download free and generate your first personalized plan in minutes. No credit card.
              Cancel anytime.
            </p>
            <div className="mt-7 flex items-center justify-center gap-3 flex-wrap">
              ...
              <Link to="/auth">
                <Button
                  size="lg"
                  variant="outline"
                  className="font-bold uppercase tracking-wider px-8 h-14 border-border-strong"
                >
                  Start free on web
                </Button>
              </Link>
            ...
            <p className="mt-8 text-xs text-muted-foreground italic max-w-xl mx-auto">
              ...
              Consult a qualified professional before significant changes to your diet or exercise
              routine.
            </p>
          </div>
        </section>
