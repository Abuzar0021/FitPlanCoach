...
function Onboarding() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col mx-auto max-w-md w-full px-5 pt-[calc(2rem+env(safe-area-inset-top))] pb-[calc(2rem+env(safe-area-inset-bottom))]">
