  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Thanks for joining FitPlanCoach. We build personalized meal plans and adaptive workouts around your body, goals, schedule, and budget.
        </Text>
        <Text style={text}><strong>Here's what to do next:</strong></Text>
        <ul style={list}>
...
const list = { fontSize: "15px", lineHeight: "24px", color: "#374151", paddingLeft: "20px", margin: "12px 0" };
